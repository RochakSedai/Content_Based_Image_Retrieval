...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / r'D:\Major Project on CBIR and Recommendation\CBIR\detect\yolo\color_best.pt', help='model path or triton URL')
